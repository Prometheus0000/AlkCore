...
public class Utils {
    ...
    public static short[] hex2RgbShort(final int colourInt) {
        ...
        final short[] rgba = { (short) rgb.getRed(), (short) rgb.getGreen(),
                (short) rgb.getBlue(), (short) rgb.getAlpha() };
        return rgba;
    }
    ...
    public static Object[] convertListToArray(final List<Object> sourceList) {
        final Object[] targetArray = sourceList
                .toArray(new Object[sourceList.size()]);
        return targetArray;
    }

    public static List<Object> convertArrayToFixedSizeList(
    ...
    public static List<Object> convertArrayListToList(
            final ArrayList<Object> sourceArray) {
     ...
     */
    public static String padWithZerosLefts(final String originalString,
            final int length) {
     ...
     * html
     */
    public static Map<Integer, String> hexColourGenerator(
        ...
        for (int a = 0; (a < colorCount)
                && (maxColorValue >= countValue); a++) {
            if (a != 0) {
                countValue += devidedvalue;
                hexColorMap.put(a, Integer.toHexString(0x10000 | countValue)
     ...
     * html
     */
    public static Map<Integer, String> hexColourGeneratorRandom(
            final int colorCount) {
        final HashMap<Integer, String> hexColorMap = new HashMap<>();
        for (int a = 0; a < colorCount; a++) {
            ...
            hexColorMap.put(a, Integer.toHexString(0x1000000 | i).substring(1)
                    .toUpperCase());
            // Logger.WARNING("" + Integer.toHexString(0x1000000 |
            // i).substring(1).toUpperCase());
        }
        return hexColorMap;
    }

    public static String appenedHexNotationToString(
            final Object hexAsStringOrInt) {
        final String hexChar = "0x";
        String result;
        if (hexAsStringOrInt.getClass() == String.class) {

            if (((String) hexAsStringOrInt).length() != 6) {
                final String temp = padWithZerosLefts((String) hexAsStringOrInt,
                        6);
                result = temp;
            }
            ...
            return result;
                ...
                || hexAsStringOrInt.getClass() == int.class) {
            final String aa = String.valueOf(hexAsStringOrInt);
            if (aa.length() != 6) {
    ...
    public static Integer appenedHexNotationToInteger(
            final int hexAsStringOrInt) {
        final String hexChar = "0x";
        String result;
    ...
    public static String sanitizeString(final String input,
            final char[] aDontRemove) {

        String output;
        final AutoMap<String> aToRemoveMap = new AutoMap<String>();
        ...
        for (final String s : aToRemoveMap) {
            for (final char e : aDontRemove) {
                if (s.charAt(0) == e) {
        ...
        output = input;
        for (final String A : aToRemoveMap) {
    ...
    public static Versioning compareModVersion(final String currentVersion,
            final String expectedVersion) {
        return compareModVersion(currentVersion, expectedVersion, "//.");
    }

    public static Versioning compareModVersion(final String currentVersion,
            final String expectedVersion, final String delimiter) {
        ...
        final Versioning[] e = new Versioning[MathUtils
                .returnLargestNumber(c.length, d.length)];
    ...
    public static SecureRandom generateSecureRandom() {
        ...
        try {
            ...
            // Default constructor would have returned insecure SHA1PRNG
            // algorithm, so make an explicit call.
    ...
    public static String calculateChecksumMD5(final Object bytes) {
    ...
    public static String calculateChecksumMD5(final byte[] bytes) {
        MessageDigest md;
        try {
    ...
    /*
     * public static AutoMap<File> getAllResourcesOnClassPath(){ File file;
     * 
     * //file = new
     * File(LocaleCache.class.getResource("locale/"+g+".lang").getFile());
     * 
     * 
     * }
     */
