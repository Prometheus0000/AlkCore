...
public class XSTR extends Random {
    ...
    /*
     * MODIFIED BY: Robotia Modification: Implemented Random class seed
     * generator
     */
    /**
     ...
     *
     * <p>
     * The hedge "approx imately" is used in the foregoing description only
    ...
    public int nextInt(final int bound) {
        ...
        /*
         * int r = next(31); int m = bound - 1; if ((bound & m) == 0) // i.e.,
         * bound is a power of 2 { r = (int) ((bound * (long) r) >> 31); } else
    ...
    public void nextBytes(final byte[] bytes_arr) {
        for (int iba = 0, lenba = bytes_arr.length; iba < lenba;) {
            for (int rndba = this.nextInt(), nba = Math.min(lenba - iba,
                    Integer.SIZE / Byte.SIZE); nba-- > 0; rndba >>= Byte.SIZE) {
